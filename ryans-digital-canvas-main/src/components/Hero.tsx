            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex justify-center gap-6 flex-wrap">
                <Button 
                  variant="outline" 
                  size="lg"
                  className="hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/50 magnetic group w-14 h-14 cursor-pointer"
                  onClick={() => {
                    console.log('GitHub button clicked');
                    window.open('https://github.com/pnb-rae', '_blank');
                  }}
                >
