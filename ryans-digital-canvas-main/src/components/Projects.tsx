              ...
              <div className="project-card-inner">
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <Button
                      size="sm"
                      className="bg-primary hover:bg-primary/90 text-white morph-button cursor-pointer"
                      onClick={(e) => {
                        e.stopPropagation();
                ...
                <div className="p-8">
                  ...
                  <div className="flex gap-4">
                    <Button
                      variant="outline"
                      className="flex-1 border-primary text-primary hover:bg-primary hover:text-primary-foreground morph-button group cursor-pointer"
                      onClick={(e) => {
                        e.stopPropagation();
                        window.open(project.liveUrl, '_blank');
                      }}
